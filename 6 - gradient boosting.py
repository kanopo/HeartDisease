...
print("--------- BALANCED -----------")
valori = gradient_boosting(X_bal, y_bal, True)
print("------------------- test ----------------")
print("precision:")
print(valori[0])
print("recall:")
...
print(valori[2])
"""
    Il gradient boosting mi sembra spaccare, con l'aggiunta 
    del bilanciamento semba veramente buono considerando che ha 5 classi
"""